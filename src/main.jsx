...
function App() {
  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        <div className="container topbar-inner">
          <button className="brand" onClick={() => navigate("store")} aria-label="Kembali ke toko">
            ...
            <span>CodeXa<span className="brand-dot">.</span></span>
          </button>
      ...
      <footer className="footer"><div className="container footer-inner"><div className="brand footer-brand"><span className="brand-mark"><Sparkles size={17} /></span><span>CodeXa<span className="brand-dot">.</span></span></div><p>Access that feels like yours.</p><div className="footer-links"><button onClick={() => navigate("help")}>Bantuan</button><button onClick={() => navigate("orders")}>Pesanan</button><button>Ketentuan</button></div></div></footer>
